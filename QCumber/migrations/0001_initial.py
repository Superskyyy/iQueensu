# Generated by Django 2.2.9 on 2020-01-08 03:54
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('enrollment', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL,
                                                 to='QCumber.EnrollmentInformation')),
                ('grading_basis', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(max_length=128)),
                ('details', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='QCumber.CourseDetail')),
                ('subject',
                 models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='QCumber.SubjectPossibleValues')),
            ],
        ),
    ]
