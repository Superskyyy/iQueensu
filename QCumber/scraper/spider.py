...
from QCumber.scraper.assets.models import Course, \
    CourseDetail, AcademicGroupPossibleValues, AcademicOrganizationPossibleValues, CampusPossibleValues, \
    CareerPossibleValues, Components, CourseDescription, EnrollmentInformation, GradingPossibleValues, \
    ...
    def solus_spider(self):  # pylint: disable=too-many-statements
        ...
        with webdriver.Remote(options=self.option, command_executor="http://chrome:4444/wd/hub",
            ...
            while True:
                ...
                wait_quick = WebDriverWait(driver, 35,
                                           poll_frequency=self.solus_random_wait(1, 3, 0.5))
                # try:
                wait_quick.until(presence_of_element_located((By.ID, "CRSE_NBR$" + str(course_nbr_id))))
                ...
                if "UNS" in course_nbr:
                    ...
                    course_nbr_id += 1
                    continue
                course_title = driver.find_element_by_id("CRSE_TITLE$" + str(course_nbr_id)).text
                if "***" in course_title:
                ...
                detail_dict["enroll_add_consent"] = driver.find_element_by_id(
                    "SSR_CRSE_OFF_VW_CONSENT$0").text
                ...
                detail_dict["course_description"] = driver.find_element_by_id(
                    "SSR_CRSE_OFF_VW_DESCRLONG$0").text
